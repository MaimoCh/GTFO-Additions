 ...
 * messages.
 */
public interface IGTFOAddnModule {

    /**
     * What other modules this module depends on.
     * <p>
     * e.g. <code>new ResourceLocation("gtfoaddn", "foo_module")</code> represents a dependency on the module
     * "foo_module" in the container "gtfoaddn"
     */
    @NotNull
    ...
    /**
     * Register packets using GTFOAddn's packet handling API here.
     */
